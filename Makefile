...
bntrs: freeModule.ml util.ml homcomp.ml trs_parse.mli trs_parse.ml trs_lex.ml main.ml
	ocamlfind ocamlopt -linkpkg -package zarith freeModule.ml util.ml homcomp.ml trs_parse.mli trs_parse.ml trs_lex.ml farith.ml matrix.ml reader.ml main.ml -o bntrs
